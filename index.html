        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Clarence
                        <span class="text-primary">Baluyot</span>
                    </h1>
                    <div class="subheading mb-5">
                       911 Block 17, San Isidro, Mariveles, Bataan · 09462017950·
                        <a href="mailto:akingprincess@gmail.com">clarencebaluyot@yahoo.com/akingprincess@gmail.com</a>
                    </div>
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">July 2020 - October 2020</span></div>
                    </div>
